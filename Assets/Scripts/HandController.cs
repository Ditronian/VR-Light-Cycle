//Hand Controls Code Thanks to Tutorial: https://www.youtube.com/watch?v=VdT0zMcggTQ&t=272s
...
public class HandController : MonoBehaviour
{
	...
	void TryInitialize()
	{
		...
		if (devices.Count > 0)
		{
			...
			if (prefab) spawnedController = Instantiate(prefab, transform);
			else
			{
				Debug.Log("Error: " + targetDevice.name);
